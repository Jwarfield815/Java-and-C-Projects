...
public class TypingTutorFrame extends JFrame {
    ...
    // JButtons to represent the fifth row of keys
    ...
    public TypingTutorFrame() {
        ...
        outputJTextArea.addKeyListener(
            new KeyListener() { // anonymouse inner class
        ...
        outputJTextArea.addFocusListener(
            new FocusAdapter() { // anoonyous inner class
    ...
    createButtons(); //create and positon keyboard buttons
    } // end constructor
